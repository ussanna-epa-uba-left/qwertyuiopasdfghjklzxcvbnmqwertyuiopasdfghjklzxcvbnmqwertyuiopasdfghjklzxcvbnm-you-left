...
if (Config.WORKTYPE == 'private') {
    Cyber.addCommand({ pattern: 'info', fromMe: true,  deleteCommand: false,  desc: INFO_DESC}, async (message, match) => { 
    ...
    Cyber.addCommand({ pattern: 'info', fromMe: false, desc: INFO_DESC}, async (message, match) => { 
