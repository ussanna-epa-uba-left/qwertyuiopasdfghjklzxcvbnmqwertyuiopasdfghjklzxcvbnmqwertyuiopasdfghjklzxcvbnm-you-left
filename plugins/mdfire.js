...
if (Config.WORKTYPE == 'private') {
    ...
    Cyber.addCommand({ pattern: 'mdfire ?(.*)', fromMe: true, desc: YTV_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    Cyber.addCommand({ pattern: 'mdfire ?(.*)', fromMe: false, desc: YTV_DESC}, async (message, match) => {
