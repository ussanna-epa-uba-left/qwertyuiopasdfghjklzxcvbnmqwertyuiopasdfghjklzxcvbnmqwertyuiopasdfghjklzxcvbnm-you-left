...
// ════════════════════WA CONNECTION🍁🍁🍁
    ...
    conn.on ('credentials-updated', async () => {
        console.log(
            chalk.blueBright.italic('▷ Login information updated! 🎅❄️☃️')
        );
    ...
    conn.on('connecting', async () => {
        console.log(`${chalk.green.bold('☃️ T-')}${chalk.blue.bold('REX')}
...
${chalk.blue.italic('🎅 Connecting to WhatsApp...▶')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.blueBright.italic('☃️❄️ Installing plugins...')
        );
